...
import {CreateProductController, UpdateProductController, GetAllProductController, GetProductByIdController, DeleteProductByIdController} from "../controller/product/index";
